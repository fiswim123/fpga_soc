...
module soc_top #(
  ...
  parameter logic [31:0] CPU_ROM_BASE      = 32'h0000_0000,
  parameter int          CPU_ROM_AW        = 12,    // 4KB
  ...
  logic                  cpu_axi_wlast, cpu_axi_wvalid, cpu_axi_wready;
  ...
  logic                  cpu_axi_rlast, cpu_axi_rvalid, cpu_axi_rready;
  ...
  axi_prot_t dma_csr_awprot, dma_csr_arprot;
  ...
  logic [3:0]            dma_axi_awqos, dma_axi_awregion;
  ...
  logic                  dma_axi_wlast, dma_axi_wuser;
  ...
  logic [3:0]            dma_axi_arqos, dma_axi_arregion;
  ...
  logic                  dma_axi_rlast, dma_axi_ruser;
  ...
  logic [3:0]            xbar_mst0_awqos, xbar_mst0_awregion;
  ...
  logic [3:0]            xbar_mst0_arqos, xbar_mst0_arregion;
  ...
  logic [3:0]            xbar_mst1_awqos, xbar_mst1_awregion;
  ...
  logic [3:0]            xbar_mst1_arqos, xbar_mst1_arregion;
  ...
  logic [3:0]            xbar_mst2_awqos, xbar_mst2_awregion;
  ...
  logic [3:0]            xbar_mst2_arqos, xbar_mst2_arregion;
  ...
  logic [3:0]            xbar_mst3_awqos, xbar_mst3_awregion;
  ...
  logic [3:0]            xbar_mst3_arqos, xbar_mst3_arregion;
  ...
  logic [31:0] pcpi_insn, pcpi_rs1, pcpi_rs2, irq, eoi;
  ...
  logic [2:0] dma_csr_awprot_xbar, dma_csr_arprot_xbar;
  ...
  picorv32_axi #(
    ...
    .mem_axi_awvalid(cpu_lite_awvalid), .mem_axi_awready(cpu_lite_awready),
    .mem_axi_awaddr(cpu_lite_awaddr),   .mem_axi_awprot(cpu_lite_awprot),
    .mem_axi_wvalid(cpu_lite_wvalid),   .mem_axi_wready(cpu_lite_wready),
    .mem_axi_wdata(cpu_lite_wdata),     .mem_axi_wstrb(cpu_lite_wstrb),
    .mem_axi_bvalid(cpu_lite_bvalid),   .mem_axi_bready(cpu_lite_bready),
    .mem_axi_arvalid(cpu_lite_arvalid), .mem_axi_arready(cpu_lite_arready),
    .mem_axi_araddr(cpu_lite_araddr),   .mem_axi_arprot(cpu_lite_arprot),
    .mem_axi_rvalid(cpu_lite_rvalid),   .mem_axi_rready(cpu_lite_rready),
  ...
  // ==========================================================
  axi_lite2axi #(
    .DATA_WIDTH(AXI_DATA_W), .ADDR_WIDTH(AXI_ADDR_W), .ID_WIDTH(AXI_ID_W)
  ) u_cpu_bridge (
    .aclk(clk), .aresetn(resetn),
    .s_axi_lite_awaddr(cpu_lite_awaddr), .s_axi_lite_awvalid(cpu_lite_awvalid),
    .s_axi_lite_awready(cpu_lite_awready),
    .s_axi_lite_wdata(cpu_lite_wdata), .s_axi_lite_wstrb(cpu_lite_wstrb),
    .s_axi_lite_wvalid(cpu_lite_wvalid), .s_axi_lite_wready(cpu_lite_wready),
    .s_axi_lite_bresp(cpu_lite_bresp), .s_axi_lite_bvalid(cpu_lite_bvalid),
    .s_axi_lite_bready(cpu_lite_bready),
    .s_axi_lite_araddr(cpu_lite_araddr), .s_axi_lite_arvalid(cpu_lite_arvalid),
    .s_axi_lite_arready(cpu_lite_arready),
    .s_axi_lite_rdata(cpu_lite_rdata), .s_axi_lite_rresp(cpu_lite_rresp),
    .s_axi_lite_rvalid(cpu_lite_rvalid), .s_axi_lite_rready(cpu_lite_rready),
    .m_axi_awid(cpu_axi_awid), .m_axi_awaddr(cpu_axi_awaddr),
    .m_axi_awlen(cpu_axi_awlen), .m_axi_awsize(cpu_axi_awsize),
    ...
    .m_axi_wlast(cpu_axi_wlast), .m_axi_wvalid(cpu_axi_wvalid),
    .m_axi_wready(cpu_axi_wready),
    .m_axi_bid(cpu_axi_bid), .m_axi_bresp(cpu_axi_bresp),
    .m_axi_bvalid(cpu_axi_bvalid), .m_axi_bready(cpu_axi_bready),
    .m_axi_arid(cpu_axi_arid), .m_axi_araddr(cpu_axi_araddr),
    .m_axi_arlen(cpu_axi_arlen), .m_axi_arsize(cpu_axi_arsize),
    .m_axi_arburst(cpu_axi_arburst),
    .m_axi_arvalid(cpu_axi_arvalid), .m_axi_arready(cpu_axi_arready),
    .m_axi_rid(cpu_axi_rid), .m_axi_rdata(cpu_axi_rdata),
    .m_axi_rresp(cpu_axi_rresp), .m_axi_rlast(cpu_axi_rlast),
  ...
  dma_axi_top u_dma (
    .clk(clk), .rst(rst),
    .dma_done_o(dma_done_o), .dma_error_o(dma_error_o),
    // Slave AXI-Lite
    .dma_s_awaddr(dma_csr_awaddr), .dma_s_awprot(dma_csr_awprot),
    .dma_s_awvalid(dma_csr_awvalid), .dma_s_awready(dma_csr_awready),
    .dma_s_wdata(dma_csr_wdata), .dma_s_wstrb(dma_csr_wstrb),
    .dma_s_wvalid(dma_csr_wvalid), .dma_s_wready(dma_csr_wready),
    .dma_s_bresp(dma_csr_bresp), .dma_s_bvalid(dma_csr_bvalid),
    .dma_s_bready(dma_csr_bready),
    .dma_s_araddr(dma_csr_araddr), .dma_s_arprot(dma_csr_arprot),
    .dma_s_arvalid(dma_csr_arvalid), .dma_s_arready(dma_csr_arready),
    .dma_s_rdata(dma_csr_rdata), .dma_s_rresp(dma_csr_rresp),
    .dma_s_rvalid(dma_csr_rvalid), .dma_s_rready(dma_csr_rready),
    .dma_s_wlast(1'b1), .dma_s_rlast(),
    // Master AXI4
    .dma_m_awid(dma_axi_awid), .dma_m_awaddr(dma_axi_awaddr),
    .dma_m_awlen(dma_axi_awlen), .dma_m_awsize(dma_axi_awsize),
    .dma_m_awburst(dma_axi_awburst), .dma_m_awlock(dma_axi_awlock),
    .dma_m_awcache(dma_axi_awcache), .dma_m_awprot(dma_axi_awprot),
    .dma_m_awqos(dma_axi_awqos), .dma_m_awregion(dma_axi_awregion),
    .dma_m_awuser(dma_axi_awuser),
    .dma_m_awvalid(dma_axi_awvalid), .dma_m_awready(dma_axi_awready),
    .dma_m_wdata(dma_axi_wdata), .dma_m_wstrb(dma_axi_wstrb),
    .dma_m_wlast(dma_axi_wlast), .dma_m_wuser(dma_axi_wuser),
    .dma_m_wvalid(dma_axi_wvalid), .dma_m_wready(dma_axi_wready),
    .dma_m_bid(dma_axi_bid), .dma_m_bresp(dma_axi_bresp),
    .dma_m_buser(dma_axi_buser),
    .dma_m_bvalid(dma_axi_bvalid), .dma_m_bready(dma_axi_bready),
    .dma_m_arid(dma_axi_arid), .dma_m_araddr(dma_axi_araddr),
    .dma_m_arlen(dma_axi_arlen), .dma_m_arsize(dma_axi_arsize),
    .dma_m_arburst(dma_axi_arburst), .dma_m_arlock(dma_axi_arlock),
    .dma_m_arcache(dma_axi_arcache), .dma_m_arprot(dma_axi_arprot),
    .dma_m_arqos(dma_axi_arqos), .dma_m_arregion(dma_axi_arregion),
    .dma_m_aruser(dma_axi_aruser),
    .dma_m_arvalid(dma_axi_arvalid), .dma_m_arready(dma_axi_arready),
    .dma_m_rid(dma_axi_rid), .dma_m_rdata(dma_axi_rdata),
    .dma_m_rresp(dma_axi_rresp), .dma_m_rlast(dma_axi_rlast),
    .dma_m_ruser(dma_axi_ruser),
    .dma_m_rvalid(dma_axi_rvalid), .dma_m_rready(dma_axi_rready)
  );

  // ==========================================================
  // DMA CSR AXI4→AXI4-Lite 桥（crossbar mst2 → DMA CSR）
  // ==========================================================
  ...
  axicb_crossbar_top #(
    ...
    .MST_NB(4), .SLV_NB(4),
    .MST_PIPELINE(0), .SLV_PIPELINE(0),
    .AXI_SIGNALING(1), .USER_SUPPORT(0), .TIMEOUT_ENABLE(0),
    ...
    .slv0_awaddr(cpu_axi_awaddr), .slv0_awlen(cpu_axi_awlen),
    .slv0_awsize(cpu_axi_awsize), .slv0_awburst(cpu_axi_awburst),
    .slv0_awlock(1'b0), .slv0_awcache(4'b0), .slv0_awprot(cpu_axi_awprot),
    .slv0_awqos(4'b0), .slv0_awregion(4'b0), .slv0_awid(cpu_axi_awid),
    .slv0_awuser(1'b0),
    .slv0_wvalid(cpu_axi_wvalid), .slv0_wready(cpu_axi_wready),
    .slv0_wlast(cpu_axi_wlast), .slv0_wdata(cpu_axi_wdata),
    .slv0_wstrb(cpu_axi_wstrb), .slv0_wuser(1'b0),
    ...
    .slv0_araddr(cpu_axi_araddr), .slv0_arlen(cpu_axi_arlen),
    .slv0_arsize(cpu_axi_arsize), .slv0_arburst(cpu_axi_arburst),
    .slv0_arlock(1'b0), .slv0_arcache(4'b0), .slv0_arprot(cpu_axi_arprot),
    .slv0_arqos(4'b0), .slv0_arregion(4'b0), .slv0_arid(cpu_axi_arid),
    .slv0_aruser(1'b0),
    .slv0_rvalid(cpu_axi_rvalid), .slv0_rready(cpu_axi_rready),
    .slv0_rid(cpu_axi_rid), .slv0_rresp(cpu_axi_rresp),
    .slv0_rdata(cpu_axi_rdata), .slv0_rlast(cpu_axi_rlast), .slv0_ruser(),
    // Slave 1: DMA
    .slv1_aclk(clk), .slv1_aresetn(resetn), .slv1_srst(rst),
    .slv1_awvalid(dma_axi_awvalid), .slv1_awready(dma_axi_awready),
    .slv1_awaddr(dma_axi_awaddr), .slv1_awlen(dma_axi_awlen),
    .slv1_awsize(dma_axi_awsize), .slv1_awburst(dma_axi_awburst),
    .slv1_awlock(dma_axi_awlock), .slv1_awcache(4'b0),
    ...
    .slv1_wlast(dma_axi_wlast), .slv1_wdata(dma_axi_wdata),
    .slv1_wstrb(dma_axi_wstrb), .slv1_wuser(1'b0),
    ...
    .slv1_araddr(dma_axi_araddr), .slv1_arlen(dma_axi_arlen),
    .slv1_arsize(dma_axi_arsize), .slv1_arburst(dma_axi_arburst),
    .slv1_arlock(dma_axi_arlock), .slv1_arcache(4'b0),
    ...
    .mst0_awaddr(xbar_mst0_awaddr), .mst0_awlen(xbar_mst0_awlen),
    .mst0_awsize(xbar_mst0_awsize), .mst0_awburst(xbar_mst0_awburst),
    .mst0_awlock(xbar_mst0_awlock), .mst0_awcache(xbar_mst0_awcache),
    .mst0_awprot(xbar_mst0_awprot), .mst0_awqos(xbar_mst0_awqos),
    .mst0_awregion(xbar_mst0_awregion), .mst0_awid(xbar_mst0_awid), .mst0_awuser(),
    .mst0_wvalid(xbar_mst0_wvalid), .mst0_wready(xbar_mst0_wready),
    .mst0_wlast(xbar_mst0_wlast), .mst0_wdata(xbar_mst0_wdata),
    .mst0_wstrb(xbar_mst0_wstrb), .mst0_wuser(),
    ...
    .mst0_araddr(xbar_mst0_araddr), .mst0_arlen(xbar_mst0_arlen),
    .mst0_arsize(xbar_mst0_arsize), .mst0_arburst(xbar_mst0_arburst),
    .mst0_arlock(xbar_mst0_arlock), .mst0_arcache(xbar_mst0_arcache),
    .mst0_arprot(xbar_mst0_arprot), .mst0_arqos(xbar_mst0_arqos),
    .mst0_arregion(xbar_mst0_arregion), .mst0_arid(xbar_mst0_arid), .mst0_aruser(),
    .mst0_rvalid(xbar_mst0_rvalid), .mst0_rready(xbar_mst0_rready),
    .mst0_rid(xbar_mst0_rid), .mst0_rresp(xbar_mst0_rresp),
    .mst0_rdata(xbar_mst0_rdata), .mst0_rlast(xbar_mst0_rlast), .mst0_ruser(1'b0),
    // Master 1: NPU LMEM
    .mst1_aclk(clk), .mst1_aresetn(resetn), .mst1_srst(rst),
    .mst1_awvalid(xbar_mst1_awvalid), .mst1_awready(xbar_mst1_awready),
    .mst1_awaddr(xbar_mst1_awaddr), .mst1_awlen(xbar_mst1_awlen),
    .mst1_awsize(xbar_mst1_awsize), .mst1_awburst(xbar_mst1_awburst),
    .mst1_awlock(xbar_mst1_awlock), .mst1_awcache(xbar_mst1_awcache),
    .mst1_awprot(xbar_mst1_awprot), .mst1_awqos(xbar_mst1_awqos),
    .mst1_awregion(xbar_mst1_awregion), .mst1_awid(xbar_mst1_awid), .mst1_awuser(),
    .mst1_wvalid(xbar_mst1_wvalid), .mst1_wready(xbar_mst1_wready),
    .mst1_wlast(xbar_mst1_wlast), .mst1_wdata(xbar_mst1_wdata),
    .mst1_wstrb(xbar_mst1_wstrb), .mst1_wuser(),
    ...
    .mst1_araddr(xbar_mst1_araddr), .mst1_arlen(xbar_mst1_arlen),
    .mst1_arsize(xbar_mst1_arsize), .mst1_arburst(xbar_mst1_arburst),
    .mst1_arlock(xbar_mst1_arlock), .mst1_arcache(xbar_mst1_arcache),
    .mst1_arprot(xbar_mst1_arprot), .mst1_arqos(xbar_mst1_arqos),
    .mst1_arregion(xbar_mst1_arregion), .mst1_arid(xbar_mst1_arid), .mst1_aruser(),
    .mst1_rvalid(xbar_mst1_rvalid), .mst1_rready(xbar_mst1_rready),
    .mst1_rid(xbar_mst1_rid), .mst1_rresp(xbar_mst1_rresp),
    .mst1_rdata(xbar_mst1_rdata), .mst1_rlast(xbar_mst1_rlast), .mst1_ruser(1'b0),
    // Master 2: DMA CSR
    .mst2_aclk(clk), .mst2_aresetn(resetn), .mst2_srst(rst),
    .mst2_awvalid(xbar_mst2_awvalid), .mst2_awready(xbar_mst2_awready),
    .mst2_awaddr(xbar_mst2_awaddr), .mst2_awlen(xbar_mst2_awlen),
    .mst2_awsize(xbar_mst2_awsize), .mst2_awburst(xbar_mst2_awburst),
    .mst2_awlock(xbar_mst2_awlock), .mst2_awcache(xbar_mst2_awcache),
    .mst2_awprot(xbar_mst2_awprot), .mst2_awqos(xbar_mst2_awqos),
    .mst2_awregion(xbar_mst2_awregion), .mst2_awid(xbar_mst2_awid), .mst2_awuser(),
    .mst2_wvalid(xbar_mst2_wvalid), .mst2_wready(xbar_mst2_wready),
    .mst2_wlast(xbar_mst2_wlast), .mst2_wdata(xbar_mst2_wdata),
    .mst2_wstrb(xbar_mst2_wstrb), .mst2_wuser(),
    ...
    .mst2_araddr(xbar_mst2_araddr), .mst2_arlen(xbar_mst2_arlen),
    .mst2_arsize(xbar_mst2_arsize), .mst2_arburst(xbar_mst2_arburst),
    .mst2_arlock(xbar_mst2_arlock), .mst2_arcache(xbar_mst2_arcache),
    .mst2_arprot(xbar_mst2_arprot), .mst2_arqos(xbar_mst2_arqos),
    .mst2_arregion(xbar_mst2_arregion), .mst2_arid(xbar_mst2_arid), .mst2_aruser(),
    .mst2_rvalid(xbar_mst2_rvalid), .mst2_rready(xbar_mst2_rready),
    .mst2_rid(xbar_mst2_rid), .mst2_rresp(xbar_mst2_rresp),
    .mst2_rdata(xbar_mst2_rdata), .mst2_rlast(xbar_mst2_rlast), .mst2_ruser(1'b0),
    // Master 3: NPU CSR
    .mst3_aclk(clk), .mst3_aresetn(resetn), .mst3_srst(rst),
    .mst3_awvalid(xbar_mst3_awvalid), .mst3_awready(xbar_mst3_awready),
    .mst3_awaddr(xbar_mst3_awaddr), .mst3_awlen(xbar_mst3_awlen),
    .mst3_awsize(xbar_mst3_awsize), .mst3_awburst(xbar_mst3_awburst),
    .mst3_awlock(xbar_mst3_awlock), .mst3_awcache(xbar_mst3_awcache),
    .mst3_awprot(xbar_mst3_awprot), .mst3_awqos(xbar_mst3_awqos),
    .mst3_awregion(xbar_mst3_awregion), .mst3_awid(xbar_mst3_awid), .mst3_awuser(),
    .mst3_wvalid(xbar_mst3_wvalid), .mst3_wready(xbar_mst3_wready),
    .mst3_wlast(xbar_mst3_wlast), .mst3_wdata(xbar_mst3_wdata),
    .mst3_wstrb(xbar_mst3_wstrb), .mst3_wuser(),
    ...
    .mst3_araddr(xbar_mst3_araddr), .mst3_arlen(xbar_mst3_arlen),
    .mst3_arsize(xbar_mst3_arsize), .mst3_arburst(xbar_mst3_arburst),
    .mst3_arlock(xbar_mst3_arlock), .mst3_arcache(xbar_mst3_arcache),
    .mst3_arprot(xbar_mst3_arprot), .mst3_arqos(xbar_mst3_arqos),
    .mst3_arregion(xbar_mst3_arregion), .mst3_arid(xbar_mst3_arid), .mst3_aruser(),
    .mst3_rvalid(xbar_mst3_rvalid), .mst3_rready(xbar_mst3_rready),
    .mst3_rid(xbar_mst3_rid), .mst3_rresp(xbar_mst3_rresp),
    .mst3_rdata(xbar_mst3_rdata), .mst3_rlast(xbar_mst3_rlast), .mst3_ruser(1'b0)
  );
  ...
  ddr #(
    ...
    .s_awaddr(xbar_mst0_awaddr), .s_awlen(xbar_mst0_awlen),
    .s_awsize(xbar_mst0_awsize), .s_awburst(xbar_mst0_awburst),
    .s_awid(xbar_mst0_awid),
    .s_wvalid(xbar_mst0_wvalid), .s_wready(xbar_mst0_wready),
    .s_wdata(xbar_mst0_wdata), .s_wstrb(xbar_mst0_wstrb),
    .s_wlast(xbar_mst0_wlast),
    ...
    .s_araddr(xbar_mst0_araddr), .s_arlen(xbar_mst0_arlen),
    .s_arsize(xbar_mst0_arsize), .s_arburst(xbar_mst0_arburst),
    .s_arid(xbar_mst0_arid),
    .s_rvalid(xbar_mst0_rvalid), .s_rready(xbar_mst0_rready),
    .s_rdata(xbar_mst0_rdata), .s_rresp(xbar_mst0_rresp),
    .s_rlast(xbar_mst0_rlast), .s_rid(xbar_mst0_rid)
  );
